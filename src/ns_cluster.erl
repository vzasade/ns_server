...
do_complete_join(NodeKVList) ->
    try
        ...
        Compat = expect_json_property_integer(<<"clusterCompatibility">>,
                                              NodeKVList),
...
perform_actual_join(RemoteNode, NewCookie, CompatVer) ->
    ...
    Status = try
        ...
        %% need to set few keys in chronicle so the old config sync works
        ok = chronicle_manager:prepare_to_join(RemoteNode, CompatVer),
