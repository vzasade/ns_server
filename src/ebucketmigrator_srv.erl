...
get_connect_info(Src, Dst, Bucket, Opts) ->
    {get_one_connect_info(proplists:get_value(src_node, Opts), Src, Bucket, Opts),
     get_one_connect_info(proplists:get_value(dst_node, Opts), Dst, Bucket, Opts)}.

get_one_connect_info(undefined, HostPort, Bucket, Opts) ->
...
get_one_connect_info(Node, HostPort, Bucket, _Opts) ->
...
init({Src, Dst, Opts}=InitArgs) ->
    ...
    {SrcConnectInfo, DstConnectInfo} = get_connect_info(Src, Dst, Bucket, Opts),
