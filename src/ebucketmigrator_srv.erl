...
-define(START_VBUCKET_FILTER_CHANGE_TIMEOUT, ns_config:get_timeout(ebucketmigrator_start_vbucket_filter_change, 120000)).
% Microseconds because we use timer:now_diff
-define(UPSTREAM_TIMEOUT, ns_config:get_timeout(ebucketmigrator_upstream_us, 600000000)).
-define(TIMEOUT_CHECK_INTERVAL, 15000).
-define(TERMINATE_TIMEOUT, ns_config:get_timeout(ebucketmigrator_terminate, 110000)).
...
get_connect_info(Node, HostPort, Bucket, _Opts) ->
    ...
    {HostPort,
     ns_memcached:get_user(Config, Node),
     ns_memcached:get_password(Config, Node),
     Bucket}.
